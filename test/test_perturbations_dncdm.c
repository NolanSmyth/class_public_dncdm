...
int main(int argc, char **argv) {
  ...
  if (pt.has_perturbations == _TRUE_) {
    ...
    int index_type=pt.index_tp_delta_dncdm;
    ...
    fprintf(output, "# k = %e\n",pt.k[index_md][index_k]);
      ...
      for (index_tau=0; index_tau < pt.tau_size; index_tau++) {
        ...
        fprintf(output,"%e %e %e %e %e %e\n",
                ...
                // delta_cdm
                pt.sources[index_md]
                [index_ic * pt.tp_size[index_md] + pt.index_tp_delta_cdm]
                [index_tau * pt.k_size[index_md] + index_k],
                // delta_dr
                pt.sources[index_md]
                [index_ic * pt.tp_size[index_md] + pt.index_tp_delta_dr]
                [index_tau * pt.k_size[index_md] + index_k],
                // delta_dncdm
                pt.sources[index_md]
                [index_ic * pt.tp_size[index_md] + pt.index_tp_delta_dncdm]
                [index_tau * pt.k_size[index_md] + index_k],
                //delta_ncdm
                pt.sources[index_md]
                [index_ic * pt.tp_size[index_md] + pt.index_tp_delta_ncdm1]
                [index_tau * pt.k_size[index_md] + index_k],
                //delta_ur
                pt.sources[index_md]
                [index_ic * pt.tp_size[index_md] + pt.index_tp_delta_ur]
                [index_tau * pt.k_size[index_md] + index_k]
                );
      }
