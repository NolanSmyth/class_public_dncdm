...
struct spectra {
  ...
  int index_tr_delta_dncdm;    /**< index of decaying non-cold dark matter density transfer function */
  ...
  int index_tr_theta_dncdm;    /**< index of decaying non-cold dark matter velocity transfer function */
